    ...
    <Section id={id} variant="default" className="relative">
      {showOverlay && (
        <div className="absolute inset-0 z-10 overflow-hidden">
          ...
          <div className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-b from-[#f0f8fa]/60 to-transparent pointer-events-none" />
          ...
          <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#f0f8fa]/80 to-transparent pointer-events-none" />
        </div>
      )}
