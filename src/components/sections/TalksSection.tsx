...
export const TalksSection = React.memo(function TalksSection({
  id,
              ...
              {talks.length > 0 ? (
                talks.map((talk, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <div className="group h-full bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-accent/50 hover:-translate-y-0.5">
                      <div className="h-1.5 bg-gradient-to-r from-accent via-[#E8C47A] to-accent transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                ...
                Array.from({ length: 4 }).map((_, index) => (
                  ...
                  >
                    <div className="h-full bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                      <div className="h-1.5 bg-gradient-to-r from-accent via-[#E8C47A] to-accent" />
                      <CardHeader className="pb-2 bg-gradient-to-r from-accent/5 to-transparent">
