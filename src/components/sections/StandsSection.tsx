    ...
    <Section id={id} variant="accent" className="relative">
      {showOverlay && (
        <div className="relative w-full">
          <div className="absolute -top-12 left-0 right-0 h-12 bg-gradient-to-b from-[#e8f4f7] via-[#e8f4f7]/50 to-transparent z-10 pointer-events-none" />
          ...
          <div className="absolute -bottom-12 left-0 right-0 h-12 bg-gradient-to-t from-[#e8f4f7] via-[#e8f4f7]/50 to-transparent z-10 pointer-events-none" />
        </div>
      )}
