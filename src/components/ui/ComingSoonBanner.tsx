...
export function ComingSoonBanner({ titulo }: ComingSoonBannerProps) {
  return (
    <div className="relative min-h-[400px] md:min-h-[500px] lg:min-h-[600px] w-full bg-gradient-to-br from-[#0d1b2a] via-[#124565] to-[#0d1b2a] overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#56bcb8]/20 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 sm:px-6 py-14 md:py-20 lg:py-28">
        ...
        >
          <div className="relative">
            ...
            <div className="w-20 h-20 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 shadow-[0_0_80px_rgba(86,188,184,0.4)] animate-subtle-pulse">
              <HardHat className="w-10 h-10 md:w-14 md:h-14 lg:w-16 lg:h-16 text-[#56bcb8]" />
            </div>
          </div>
        </motion.div>
